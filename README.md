...
| Semana | Tema | Abrir no Colab | Baixar Notebook | Baixar Aula Teórica | Apostilas (PDF) |
|:------:|------|:--------------:|:---------------:|:-------------------:|:----------------:|
...
| 11 | Python + PostgreSQL | *em breve* | *em breve* | [⬇ Semana11.html](https://github.com/cfneves/turma05-analise-de-dados-com-python/blob/main/11_Python_e_PostgreSQL/Aluno/html/aula_teorica.html) | - |
| 12 | Python + PostgreSQL para ETL | *em breve* | *em breve* | [⬇ Semana12.html](https://github.com/cfneves/turma05-analise-de-dados-com-python/blob/main/12_Python_PostgreSQL_para_ETL/Aluno/html/aula_teorica.html) | - |
